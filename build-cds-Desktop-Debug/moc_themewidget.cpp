...
QT_MOC_LITERAL(3, 22, 11), // "updateChart"
QT_MOC_LITERAL(4, 34, 1) // "k"

    },
    "ThemeWidget\0updateUI\0\0updateChart\0k"
};
...
void ThemeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateChart((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject ThemeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ThemeWidget.data,
      qt_meta_data_ThemeWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ThemeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ThemeWidget.stringdata0))
        return static_cast<void*>(const_cast< ThemeWidget*>(this));
